...
public class PostServiceImpl implements PostService {
    ...
    @Override
    public Post update(long id, ReqUpdatePost post) {
        return postRepo.update(id, post);
    }

    @Override
    public List<PostDtos> findByAuthor(String author) {
        return (List<PostDtos>) listMapper.mapList(postRepo.findByAuthor(author),new PostDtos());
    }

    @Override
    public List<PostDtos> findByAuthorName(String authorName) {
        return (List<PostDtos>) listMapper.mapList(postRepo.findByAuthorName(authorName),new PostDtos());
    }
