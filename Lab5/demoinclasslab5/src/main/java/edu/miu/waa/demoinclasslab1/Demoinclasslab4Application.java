...
//		posts.add(p2);
//
//		User user1 = new User("John",posts,"uinan@miu.edu", "umur", "inan", "$2a$12$IKEQb00u5QpZMx4v5zMweu.3wrq0pS7XLCHO4yHZ.BW/yvWu1feo2");
...
//
//		posts1.add(p3);
//		User user2 = new User( "Mira",posts1,"john@miu.edu", "john", "doe", "$2a$12$IKEQb00u5QpZMx4v5zMweu.3wrq0pS7XLCHO4yHZ.BW/yvWu1feo2");
//
//		return args ->{
//			userRepo.save(user1);
//			userRepo.save(user2);
